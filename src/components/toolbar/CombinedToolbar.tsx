...
// 导入Heroicons图标
import {
  SunIcon, MoonIcon, CodeBracketIcon, ListBulletIcon,
  Bars3Icon, ArrowDownTrayIcon
...
import {
  ...
  Table, Code, AlignLeft, AlignCenter, AlignRight, AlignJustify
} from 'lucide-react';
...
const CombinedToolbar: React.FC<CombinedToolbarProps> = ({
  isFullscreen = false,
  onToggleFullscreen,
  onFormatText,
  onExport,
  ...
  return (
    <div className="toolbar">
      ...
      <div className="flex items-center space-x-3">
        {/* 字数统计 */}
        <div className="hidden md:flex items-center text-xs text-gray-500 dark:text-gray-400 space-x-3 bg-gray-100/70 dark:bg-gray-700/70 px-3 py-1 rounded-full">
