...
const TailwindToolbarFixed: React.FC<TailwindToolbarProps> = ({
  content,
  isDark,
  isFullScreen,
  onToggleTheme,
  ...
  const buttonClass = `
    ...
    before:absolute before:inset-0 before:bg-gradient-to-r before:from-blue-500/0 before:via-blue-400/10 before:to-blue-500/0
        ...
        >
          <motion.h1
            className={`text-xl font-bold bg-gradient-to-r ${
              isDark
                ? 'from-blue-400 via-blue-300 to-cyan-400'
          ...
          <motion.div
            className="h-0.5 bg-gradient-to-r from-transparent via-blue-500 to-transparent mt-1 mx-auto"
            initial={{ width: 0 }}
            animate={{ width: "60%" }}
          ...
          <div className="relative">
            ...
            {showExportMenu && (
              <motion.div
                ...
                className={`
                  absolute right-0 top-full mt-2 w-48 rounded-lg shadow-lg border z-[100]
                  ${isDark
...
export default TailwindToolbarFixed;
