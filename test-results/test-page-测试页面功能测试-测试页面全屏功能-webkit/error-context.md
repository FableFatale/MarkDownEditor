...
- Name: 测试页面功能测试 >> 测试页面全屏功能
- Location: D:\MarkDownEditor\e2e\test-page.spec.ts:41:3

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('button', { name: /进入全屏/ }) resolved to 3 elements:
...
Call log:
  - waiting for getByRole('button', { name: /进入全屏/ })
    ...
    at D:\MarkDownEditor\e2e\test-page.spec.ts:46:54
```
