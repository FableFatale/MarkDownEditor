...
- Name: 测试页面功能测试 >> 测试页面设置对话框功能
- Location: D:\MarkDownEditor\e2e\test-page.spec.ts:61:3

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('button', { name: /设置/ }) resolved to 2 elements:
...
Call log:
  - waiting for getByRole('button', { name: /设置/ })
    ...
    at D:\MarkDownEditor\e2e\test-page.spec.ts:63:52
```
