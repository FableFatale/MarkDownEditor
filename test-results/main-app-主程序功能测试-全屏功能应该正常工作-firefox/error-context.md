...
- Name: 主程序功能测试 >> 全屏功能应该正常工作
- Location: D:\MarkDownEditor\e2e\main-app.spec.ts:44:3
...
Locator: getByRole('button', { name: /进入全屏/ })
Expected: visible
...
Call log:
  ...
  - waiting for getByRole('button', { name: /进入全屏/ })
    ...
    at D:\MarkDownEditor\e2e\main-app.spec.ts:47:36
```
