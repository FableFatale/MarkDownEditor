...
- Name: 主程序功能测试 >> 预览区域应该正确显示内容
- Location: D:\MarkDownEditor\e2e\main-app.spec.ts:156:3

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: getByText('预览区域') resolved to 2 elements:
    1) <div class="cm-line">4. 拖拽中间分隔条调整编辑器和预览区域大小</div> aka getByText('4. 拖拽中间分隔条调整编辑器和预览区域大小')
    2) <li>拖拽中间分隔条调整编辑器和预览区域大小</li> aka getByText('拖拽中间分隔条调整编辑器和预览区域大小', { exact: true })

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('预览区域')

    at D:\MarkDownEditor\e2e\main-app.spec.ts:158:42
```
