...
- Name: 主程序功能测试 >> 主题切换功能应该正常工作
- Location: D:\MarkDownEditor\e2e\main-app.spec.ts:25:3
...
Locator: locator('button[title*="切换到深色模式"], button[aria-label*="切换到深色模式"]').first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('button[title*="切换到深色模式"], button[aria-label*="切换到深色模式"]').first()

    at D:\MarkDownEditor\e2e\main-app.spec.ts:28:31
```
