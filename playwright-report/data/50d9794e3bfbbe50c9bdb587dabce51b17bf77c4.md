...
- Name: 主程序功能测试 >> 页面应该正确加载
- Location: D:\MarkDownEditor\e2e\main-app.spec.ts:11:3
...
Locator: locator('h6:has-text("预览区域")')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('h6:has-text("预览区域")')

    at D:\MarkDownEditor\e2e\main-app.spec.ts:19:55
```
