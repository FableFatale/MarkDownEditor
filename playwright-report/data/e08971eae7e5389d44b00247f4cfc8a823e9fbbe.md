...
- Name: 主程序功能测试 >> 深色模式下预览区域应该是深色背景
- Location: D:\MarkDownEditor\e2e\main-app.spec.ts:164:3
...
Call log:
  - waiting for getByRole('button', { name: /切换到深色模式/ })

    at D:\MarkDownEditor\e2e\main-app.spec.ts:166:57
```
